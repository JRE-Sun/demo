                ...
                return function (newImage) {
                    newImage.args.forEach(function (image) {
                        if (!this.imageExists(images, image)) {
                            ...
                            log('Added image #' + (images.length), typeof(image) === "string" ? image.substring(0, 100) : image.src);
                        }
                    }, this);
                };
            };
            ...
            ImageLoader.prototype.fetch = function (nodes) {
                ...
                this.images.forEach(function (image, index) {
                    image.promise.then(function () {
                        log("Succesfully loaded image #" + (index + 1), image.src);
                    }, function (e) {
                        log("Failed loading image #" + (index + 1), image.src, e);
                    });
                });
            ...
            function LinearGradientContainer(imageData) {
                    ...
                    imageData.args[0].split(/\s+/).reverse().forEach(function (position, index) {
                        switch (position) {
                            ...
                            default: // percentage or absolute length
                                // TODO: support absolute start point positions (e.g., use bounds to convert px to a
                                // ratio)
                ...
                this.colorStops = imageData.args.slice(hasDirection ? 1 : 0).map(function (colorStop) {
                    ...
                    return {
                        ...
                        // TODO: support absolute stop positions (e.g., compute gradient line length & convert px to
                        // ratio)
...
// TODO: support <angle> (e.g. -?\d{1,3}(?:\.\d+)deg, etc. : https://developer.mozilla.org/docs/Web/CSS/angle )
        ...
        15: [function (_dereq_, module, exports) {
            ...
            NodeParser.prototype.parse = function (stack) {
                ...
                var negativeZindex = stack.contexts.filter(negativeZIndex); // 2. the child stacking
                                                                            // contexts with
                ...
                var positiveZindex                    = stack.contexts.filter(positiveZIndex); // 7. the child stacking
                                                                                               // contexts with
            ...
            NodeParser.prototype.renderTextDecoration = function (container, bounds, metrics) {
                switch (container.css("textDecoration").split(" ")[0]) {
                    case "underline":
                        ...
                        // TODO As some browsers display the line as more than 1px if the font-size is big, need to
                        // take that into account both in position and size
